-- Rolli: ensure reveal RPCs exist (safe to re-run if 007 was skipped)
-- Also reloads the PostgREST schema cache so Supabase API sees new functions.
...
-- Refresh API schema cache (fixes "Could not find the function ... in the schema cache")
